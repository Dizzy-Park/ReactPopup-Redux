...
const MsgWrapper = styled.div<{
  ...
  & .close {
    ...
    margin: 0;
    border: 0;
    background: url(${Closed("25282b")}) no-repeat center center;
  ...
  ${props => {
    switch (typeof props.borderShape) {
      case "number":
        return css`
          border-radius: ${props.borderShape}px;
        `;
      case "string":
        return css`
          border-radius: ${props.borderShape};
        `;
      default:
        return css`
          border-radius: 15px;
...
function AbsPopupBase(props: IAbsPopupProps) {
...
const AbsPopup = memo(AbsPopupBase);
